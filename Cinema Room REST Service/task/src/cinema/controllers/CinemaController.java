...
public class CinemaController {
    ...
    public ResponseEntity<String> checkSeat(@RequestBody Seat seat) {
        ...
        Seat seatToBook = seats[cinema.getArrayPosition(seat.getRow(), seat.getColumn())];
    ...
    public ResponseEntity<String> returnStats(@RequestParam(required = false) @RequestBody String password) {
